...
$config['wallet']['host'] = 'localhost:33553';
$config['wallet']['username'] = 'fanchuancoinrpc';
$config['wallet']['password'] = 'AyeJrXbMUCzN2an9vXTBUoPsW4fStREz9oQrHwNmpjHb';
 ...
 **/
$config['gettingstarted']['coinname'] = 'fanchuancoin';
...
$config['memcache']['keyprefix'] = 'mpos_fcc_';
