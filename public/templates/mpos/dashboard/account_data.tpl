...
{else if $GLOBAL.fees > 0}
        矿池收取<font color="orange">{if $GLOBAL.fees < 0.0001}{$GLOBAL.fees|escape|number_format:"8"}{else}{$GLOBAL.fees|escape}{/if}%</font> 费用
{else}
...
{/if}
    ...
    <table class="tablesorter" cellspacing="0">
      <thead>
        <tr><th colspan="2"><b>{$GLOBAL.config.currency} 账号余额</b></th></tr>
      </thead>
      <tr>
